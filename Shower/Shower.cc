...
int main(int argc,char** argv)
{
  ...
  ShowerDetectorConstruction *detConstruction = new ShowerDetectorConstruction;
  ...
  runManager->SetUserInitialization(new ShowerActionInitialization(detConstruction));
