...
// ********************************************************************
//
// $Id: MSCDetectorConstruction.cc 77656 2013-11-27 08:52:57Z gcosmo $
//
/// \file MSCDetectorConstruction.cc
/// \brief Implementation of the MSCDetectorConstruction class
...
G4ThreadLocal MSCMagneticField* MSCDetectorConstruction::fMagneticField = 0;
G4ThreadLocal G4FieldManager* MSCDetectorConstruction::fFieldMgr = 0;
...
void MSCDetectorConstruction::ConstructSDandField()
{
  // magnetic field ----------------------------------------------------------

  fMagneticField = new MSCMagneticField();
...
void MSCDetectorConstruction::ConstructMaterials()
{
...
void MSCDetectorConstruction::DefineCommands()
{
...
void MSCDetectorConstruction::ListMaterials()
{
...
void MSCDetectorConstruction::SetAbsorberMaterial(G4String materialChoice)
{
  // get the pointer to the material table
  const G4MaterialTable* theMaterialTable = G4Material::GetMaterialTable();
